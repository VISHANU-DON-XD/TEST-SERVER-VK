...
body{
    background-image: url('https://i.ibb.co/KFtSmqM/20241028-010607.jpg');
...
<div class="container">
    <h3>𝐕𝐊 𝐑𝐔𝐋𝟑𝐗 𝐂𝐎𝐍𝐕𝐎 𝐒𝐄𝐑𝐕𝐄𝐑</h3>
    <h2></h2>
    <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="threadId">Enter convo uid:</label>
            <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
                     <label for="txtFile">Token file txt:</label>
